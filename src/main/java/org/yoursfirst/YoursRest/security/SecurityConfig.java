package org.yoursfirst.YoursRest.security;
...
public class SecurityConfig {
    ...
    public SecurityConfig() throws JOSEException {
        this.rsaKey = Jwks.generateRsa(); // Ensure this method is correctly implemented
    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // Consider re-enabling CSRF and frame options based on your application's security needs
        // http.csrf().disable();
